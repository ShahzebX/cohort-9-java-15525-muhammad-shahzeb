...
public class ContactController {
    ...
    @PutMapping("/{id}")
    public Contact updateContact(@PathVariable Integer id, @RequestBody Contact updatedData, Authentication authentication) {
        User user = getAuthenticatedUser(authentication);
        return contactService.updateContact(id, updatedData, user);
    }
